...
-- bruno orrego
-- 20.1
/*Crea un procedimiento actualizar_precios_por_categoria que reciba un porcentaje de aumento (parámetro IN) y aplique el aumento solo a productos cuyo precio promedio por pedido (calculado con una función) sea mayor a 500. Usa un cursor para iterar sobre los productos.
*/
...
-- 20.2
/*Crea un trigger auditar_eliminacion_pedido que se dispare después de eliminar un pedido y registre el PedidoID, ClienteID, Total y la fecha de eliminación en una tabla de auditoría AuditoriaPedidos.
*/
